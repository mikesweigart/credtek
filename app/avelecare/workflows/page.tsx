// Workflows — credentialing templates Eastside Hospital uses across service
...
const TEMPLATES: Template[] = [
  {
    ...
    description:
      "End-to-end workflow for new Eastside Hospital Emergency clinicians across partner hospitals and states.",
    stages: [
      { name: "Intake & Application", sla: "3 days", owner: "Eastside Hospital MSO" },
      { name: "Primary Source Verification", sla: "10 days", owner: "Eastside Hospital MSO" },
      { name: "Facility Privileges", sla: "21 days", owner: "Facility med staff office" },
      { name: "Compliance & HR", sla: "5 days", owner: "Eastside Hospital HR" },
      { name: "Payer Enrollment", sla: "30–45 days", owner: "Eastside Hospital payer liaison" },
      { name: "Final Approval & Go-Live", sla: "2 days", owner: "Eastside Hospital MSO Lead" },
    ],
  },
  {
  ...
  },
  {
    ...
    stages: [
      { name: "Intake & Application", sla: "3 days", owner: "Eastside Hospital MSO" },
      { name: "Primary Source Verification", sla: "10 days", owner: "Eastside Hospital MSO" },
      { name: "State OMH / Crisis Attestations", sla: "14 days", owner: "Eastside Hospital BH program lead" },
      { name: "Compliance & HR", sla: "5 days", owner: "Eastside Hospital HR" },
      { name: "BH Payer Enrollment", sla: "30–45 days", owner: "Eastside Hospital payer liaison" },
      { name: "Final Approval & Go-Live", sla: "2 days", owner: "Eastside Hospital MSO Lead" },
    ],
  },
  {
    ...
    stages: [
      { name: "Intake & Application", sla: "3 days", owner: "Eastside Hospital MSO" },
      { name: "Primary Source Verification", sla: "10 days", owner: "Eastside Hospital MSO" },
      { name: "District Background Checks", sla: "10–21 days", owner: "Eastside Hospital HR" },
      { name: "Pediatric Care Attestation", sla: "5 days", owner: "Eastside Hospital SH lead" },
      { name: "Medicaid + CHIP Enrollment", sla: "30–45 days", owner: "Eastside Hospital payer liaison" },
      { name: "Final Approval & Go-Live", sla: "2 days", owner: "Eastside Hospital MSO Lead" },
    ],
  },
  {
    ...
    stages: [
      ...
      { name: "Compliance & HR", sla: "5 days", owner: "Eastside Hospital HR" },
      { name: "State Medicaid + RHTP Enrollment", sla: "30–60 days", owner: "Eastside Hospital payer liaison" },
      { name: "Final Approval & Go-Live", sla: "2 days", owner: "Eastside Hospital MSO Lead" },
    ],
  },
];
  ...
  return (
    <>
      <AvelTopbar
        ...
        subtitle="Standardize and scale credentialing for every Eastside Hospital service line. Each template defines stages, SLAs, and who owns each step."
      />
